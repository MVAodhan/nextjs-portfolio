...
/**
 * frontend\public\linkedin.svg
 */

const Nav = ({ navLinks }: { navLinks?: any }) => {
  return (
    <nav className="flex w-screen py-2 sticky pr-6">
      <div className="w-3/6 lg:w-1/2 flex items-center"></div>
      <div className="w-full lg:w-1/2 flex justify-end gap-2">
        <div className="w-full justify-end items-center gap-6 flex xl:w-4/5 mt-2">
          <Link href="https://github.com/MVAodhan" target="_blank">
            <svg
              role="img"
              viewBox="0 0 24 24"
              xmlns="http://www.w3.org/2000/svg"
              className="h-[15px] w-[15px] sm:h-[25px] sm:w-[25px] fill-current"
            >
              <title>GitHub</title>
          ...
          <Link href="https://www.linkedin.com/in/mvaodhan/" target="_blank">
            <svg
              role="img"
              viewBox="0 0 24 24"
              xmlns="http://www.w3.org/2000/svg"
